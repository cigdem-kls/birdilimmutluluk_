...
class PieChartSample8 extends StatefulWidget {
  @override
  State<StatefulWidget> createState() => PieChartSample8State();
}

class PieChartSample8State extends State {
  int touchedIndex = -1;
